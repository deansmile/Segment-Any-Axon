...
def get_dataloader(split, patch_shape, batch_size, train_instance_segmentation):
    ...
    train_segmentation_dir="/scratch/ds5725/micro-sam/data/train/instance_labeling"
    val_image_dir="/scratch/ds5725/micro-sam/data/val/image_tif"
    val_segmentation_dir="/scratch/ds5725/micro-sam/data/val/instance_labeling"
...
def export_model(checkpoint_name, model_type):
    ...
    export_path = export_folder.joinpath("finetuned_hela_model_ins.pth")
