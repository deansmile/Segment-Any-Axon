...
work_dir = './work_dirs/rsprompter/samseg-maskrcnn-axonmyelin'
custom_imports = dict(imports=['mmdet.rsprompter', 'configs.rsprompter.samseg-maskrcnn-axonmyelin'], allow_failed_imports=False)
default_hooks = dict(
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-axonmyelin', group='samseg-maskrcnn', name='samseg-maskrcnn-axonmyelin'))
                ]
visualizer = dict(
...
hf_sam_pretrain_ckpt_path = "/home/shing6444/PycharmProjects/Segment-Any-Axon/RSPrompter/best.pt"
# # sam large model
...
# # sam huge model
# hf_sam_pretrain_name = "facebook/sam-vit-base"
# hf_sam_pretrain_ckpt_path = "~/.cache/huggingface/hub/models--facebook--sam-vit-huge/snapshots/87aecf0df4ce6b30cd7de76e87673c49644bdf67/model.safetensors"
model = dict(
    type='SAMSegMaskRCNN',
    backbone=dict(
...
dataset_type = 'AxonMyelin'

#### should be changed align with your code root and data root
code_root = '/home/shing6444/PycharmProjects/Segment-Any-Axon/RSPrompter'
data_root = '/home/shing6444/PycharmProjects/Segment-Any-Axon/datasets'
